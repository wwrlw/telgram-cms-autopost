...
exports.TelegramPublishService = void 0;
class TelegramPublishService {
    ...
    async deletePost(messageId, channelId) {
        try {
    ...
    formatMessageText(post, channel) {
    ...
    async sendMedia(post, channel, caption) {
    ...
    async getPostsStats(channelId) {
        try {
            ...
            const messages = result.result.filter((update) => update.channel_post &&
            ...
            const totalViews = messages.reduce((sum, msg) => sum + (msg.channel_post.views || 0), 0);
    ...
    analyzeBestPostingTimes(messages) {
        const hourStats = messages.reduce((acc, msg) => {
    ...
    async getSubscribersGrowth(channelId) {
    ...
    async getEngagementData(channelId) {
...
exports.TelegramPublishService = TelegramPublishService;
