    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="mb-8">
        <div class="flex justify-between items-center">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Каналы для публикации</h1>
      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div v-if="loading" class="p-8 text-center">
          ...
          <p class="mt-2 text-sm text-gray-500">Загружаем каналы...</p>
        </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="ml-4">
                  <div class="flex items-center">
                    ...
                    <span :class="[
                      ...
                      channel.channel_type === 'public' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'
                    ]">
                      {{ channel.channel_type === 'public' ? 'Публичный' : 'Приватный' }}
                    </span>
                  </div>
                  <p class="text-sm text-gray-500">ID: {{ channel.channel_id }}</p>
              ...
              <div class="flex items-center space-x-2">
                ...
                <button
                  ...
                  :class="[
                    'text-sm font-medium',
                    channel.is_active ? 'text-red-600 hover:text-red-900' : 'text-green-600 hover:text-green-900'
                  ]"
                >
        ...
        <div class="mt-3">
          ...
          <form @submit.prevent="saveChannel">
            <div class="space-y-4">
              ...
              <div>
                <label for="channel_id" class="block text-sm font-medium text-gray-700">ID канала</label>
                <input
                  type="text"
                  id="channel_id"
              ...
              <div>
                <label for="channel_type" class="block text-sm font-medium text-gray-700">Тип канала</label>
                <select
                  id="channel_type"
