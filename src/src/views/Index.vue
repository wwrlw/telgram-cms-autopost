<template>
    <div class="news-container">
      ...
      <div class="news-grid">
        <div v-for="item in newsData" :key="item._id" class="news-card">
          ...
          <div class="news-content">
            ...
            <div v-if="item.media" class="news-media">
              <img v-if="item.media.type === 'MessageMediaPhoto'" :src="getMediaPath(item.media.file_path)" alt="News image" class="news-image">
            </div>
            
            <div v-if="item.is_unique" class="unique-badge">Эксклюзив</div>
          </div>
        </div>
      </div>
    </div>
