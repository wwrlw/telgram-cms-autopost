        ...
        <div class="p-5">
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                <dt class="text-sm font-medium text-gray-500 truncate">Всего категорий</dt>
      ...
      <div class="bg-white overflow-hidden shadow rounded-lg">
        <div class="p-5">
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                <dt class="text-sm font-medium text-gray-500 truncate">С описанием</dt>
                <dd class="text-lg font-medium text-gray-900">{{ categoriesWithDescription }}</dd>
              </dl>
            </div>
          </div>
        </div>
...
const activeCount = computed(() => {
  return props.categories.filter(category => category.is_active).length
})
...
const categoriesWithDescription = computed(() => {
  return props.categories.filter(category => category.description && category.description.trim()).length
})
</script> 