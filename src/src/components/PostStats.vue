<template>
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div v-if="stats" class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div
                v-if="stats.views || stats.views === 0"
            ...
            <div
                v-if="stats.reactions || stats.reactions === 0"
            ...
            >
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-semibold text-pink-900">
            ...
            <div
                v-if="stats.comments || stats.comments === 0"
            ...
            <div
                v-if="stats.forwards || stats.forwards === 0"
        ...
        <div
            v-if="
                ...
                Object.keys(stats.reactions_detail).length > 0
            "
            class="mt-6"
        >
        ...
        <div v-if="!stats" class="text-center py-8">
            ...
            <p class="text-xs text-gray-400 mt-1">
                Статистика собирается автоматически при парсинге постов
            </p>
        </div>
