...
const props = defineProps({
    ...
    type: {
        type: String,
        required: true,
        validator: (value) => ['posts', 'channels', 'categories'].includes(value)
    }
});
...
const statsConfig = {
    posts: [
        ...
        },
        {
            ...
            iconBg: 'bg-green-500',
            getValue: (totalCount, data) => data.filter(post => post.is_unique).length
        },
        {
            key: 'today',
            label: 'За сегодня',
            ...
            getValue: (totalCount, data) => {
                ...
                return data.filter(post => new Date(post.timestamp).toDateString() === today).length;
            }
        }
    ],
    channels: [
        {
            key: 'total',
            label: 'Всего каналов',
            iconPath: 'M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0V3a1 1 0 011 1v10.586l2.707 2.707A1 1 0 0119 19H5a1 1 0 01-.707-1.707L7 14.586V4z',
        ...
        },
        {
            ...
            getValue: (totalCount, data) => {
                ...
                return data.filter(channel => new Date(channel.created_at) > oneDayAgo).length;
            }
        }
    ],
    categories: [
        ...
        },
        {
            ...
            iconPath: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
            iconColor: 'text-green-400',
            getValue: (totalCount, data) => data.filter(category => category.is_active).length
        },
        {
            key: 'inactive',
            label: 'Неактивные',
        ...
        },
        {
            ...
            iconPath: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
            iconColor: 'text-blue-400',
            getValue: (totalCount, data) => data.filter(category => category.description && category.description.trim()).length
        }
    ]
};
