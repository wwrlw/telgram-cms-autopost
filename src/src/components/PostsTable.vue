                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr
                            ...
                            :key="post._id"
                            :class="{
                                'bg-blue-50': selectedPosts.includes(post._id),
                            }"
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p
                                            class="text-sm text-gray-500 line-clamp-6"
                                        >
                                            {{ post.text }}
                                        </p>
                                        <div
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div
                                    v-if="post.stats"
                                    class="flex flex-col space-y-1 text-xs text-gray-600"
                                >
                                    <div
                                    ...
                                    <div
                                        v-if="
                                            post.stats.reactions !== undefined
                                        "
                                        class="flex items-center space-x-1"
                                    >
                                        <span>😍</span>
                                        <span>{{
                                            formatNumber(post.stats.reactions)
                                        }}</span>
                                    </div>
                                    <div
                                    ...
                                    <div
                                        v-if="post.stats.forwards !== undefined"
                                        class="flex items-center space-x-1"
                                    >
                                        <span>🔄</span>
                                        <span>{{
                                            formatNumber(post.stats.forwards)
                                        }}</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex flex-col space-y-1">
                                    ...
                                    >
                                        <svg
                                            class="mr-1.5 h-2 w-2 text-orange-400"
                                            fill="currentColor"
                                            viewBox="0 0 8 8"
                                        >
                                            <circle cx="4" cy="4" r="3" />
...
watch(selectedPosts, () => {
    selectAll.value =
        selectedPosts.value.length === paginatedPosts.value.length &&
