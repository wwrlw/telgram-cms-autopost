            ...
            <div id="signup-form-container" class="hidden">
                ...
                <form id="signup-form" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="signup-first-name" class="block text-sm font-semibold text-gray-700 mb-1">First
                                Name</label>
                        ...
                        <div>
                            <label for="signup-last-name" class="block text-sm font-semibold text-gray-700 mb-1">Last
                                Name</label>
