    ...
    <div>
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="relative top-10 mx-auto p-6 border w-full max-w-4xl shadow-lg rounded-md bg-white"
                        @click.stop
                    >
                        <div class="mb-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                Внесите изменения в пост. Поля можно оставить
                                пустыми для сохранения текущего значения.
                            </p>
                        </div>
